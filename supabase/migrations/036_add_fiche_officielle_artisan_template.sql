-- =====================================================
-- 12e modèle PDF : Fiche Officielle Artisan
-- Template vierge pour impression et remplissage manuel
-- Design identique à la fiche d'enregistrement (reportlab)
-- =====================================================

INSERT INTO public.document_templates (name, description, category, is_system, layout) VALUES
(
  'Fiche Officielle Artisan',
  'Fiche officielle artisan vierge pour impression – Design BROBROLI avec sections identification, profil, catégorisation, documents, équipements, zone et engagement',
  'report',
  true,
  '{
    "pageFormat": "a4",
